...
<div class='wrap wpoa-settings'>
	...
	<div id="wpoa-settings-col1" class="wpoa-settings-column">
		<form method='post' action='options.php'>
			...
			<!-- START Login with ORCiD section -->
			<div id="wpoa-settings-section-login-with-orcid" class="wpoa-settings-section">
			<h3>Login with ORCiD</h3>
			<div class='form-padding'>
			<table class='form-table'>
				<tr valign='top'>
				<th scope='row'>Enabled:</th>
				<td>
					<input type='checkbox' name='wpoa_orcid_api_enabled' value='1' <?php checked(get_option('wpoa_orcid_api_enabled') == 1); ?> />
				</td>
				</tr>
				...
				<th scope='row'>Client ID:</th>
				<td>
					<input type='text' name='wpoa_orcid_api_id' value='<?php echo get_option('wpoa_orcid_api_id'); ?>' />
				</td>
				</tr>
				...
				<th scope='row'>Client Secret:</th>
				<td>
					<input type='text' name='wpoa_orcid_api_secret' value='<?php echo get_option('wpoa_orcid_api_secret'); ?>' />
				</td>
				</tr>
			</table> <!-- .form-table -->
			<p>
				<strong>Instructions:</strong>
				<ol>
					<li>At ORCid, access <a href='http://members.orcid.org/api/introduction-orcid-member-api' target="_blank">Developer Center</a> for instructions.</li>
				</ol>
			</p>
			<?php submit_button('Save all settings'); ?>
			</div> <!-- .form-padding -->
			</div> <!-- .wpoa-settings-section -->
			<!-- END Login with ORCiD section -->
